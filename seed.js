...
async function seed() {
  try {
    ...
    const clientes = [
      ['Lucas Ferreira Santos',   '11991234501', {rua:'Rua das Academias',numero:'142',bairro:'Vila Madalena',cidade:'São Paulo',cep:'05435-000'}, 'Alérgico a glúten'],
    ...
    // --- CRIAÇÃO DO CARDÁPIO (PIZZAS) ---
    // Lista com: Nome, Descrição, Ingredientes, Preços (P, M, G) e Categoria
    const pizzas = [
